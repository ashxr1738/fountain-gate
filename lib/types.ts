...
export type EquipmentRequest = { id: string; asset_id: string; user_id: string; purpose: string; requested_from: string; requested_until: string; status: RequestStatus; created_at: string; approved_at: string | null; approved_by: string | null; rejection_reason: string | null; asset?: Asset; requester?: Pick<Profile, "name" | "email"> };
